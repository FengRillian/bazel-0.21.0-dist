...
for i in $*; do
  ...
  case "$i" in
    ...
    *javac-9+181-r4173-1.jar) OUTPUT_PATH=third_party/java/jdk/langtools/javac-9+181-r4173-1.jar ;;
...
if [ ! -f ${PACKAGE_DIR}/third_party/java/jdk/langtools/javac-9+181-r4173-1.jar ]; then
  cp ${PACKAGE_DIR}/third_party/java/jdk/langtools/javac7.jar \
      ${PACKAGE_DIR}/third_party/java/jdk/langtools/javac-9+181-r4173-1.jar
fi
